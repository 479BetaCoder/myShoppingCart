...
Show the code – Mainly this contains the pages for product categories. Using the form and post method, the checked checkbox id (which is the product id associated) is passed to addCartView.
